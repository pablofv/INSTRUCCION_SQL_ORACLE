...
/* CÓDIGOS QUE ESTÁN CALCULADOS EN SQL SERVER, EL HDT FIGURA EN LOS PROCESOS, PERO NO HAY NINGUNA CAUSA, NO SE SI PORQUE NO SE USÓ REALMENTE O SIMPLEMENTE PORQUE NO HAY CAUSAS CON ESE CÓDIGO */
...
/* CÁMARAS FEDERALES, TODAS CON LOS MISMOS CÓDIGOS */
...
/* LOS CÓDIGOS QUE NOS INDICARON EN INSTRUCCIÓN QUE ESTÁN USANDO PARA FINALIZAR CAUSAS, SE LOS AGREGO TAMBIÉN A FEDERAL */
