CREATE TABLE EST_TOTAL_A(
    ...
    TA_CAMARA NUMBER(2),
CONSTRAINT CP_TOTAL_A PRIMARY KEY ("TA_IDEXP", "TA_OFICINA", "TA_RN", "TA_TIPO_DE_DATO", "TA_NUMERO_DE_EJECUCION"));
...
CREATE TABLE EST_SALIDOS(
    ...
    CONSTRAINT CP_SALIDOS PRIMARY KEY (SAL_IDEXP, SAL_FECHA, SAL_CODIGO, SAL_OFICINA, SAL_RN, SAL_NUMERO_DE_EJECUCION));
