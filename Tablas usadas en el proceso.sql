CREATE TABLE EST_TOTAL_A(
    ...
    TA_TIPO_DE_DATO NUMBER(1,0) NOT NULL ENABLE,
    TA_FECHA_PROCESO TIMESTAMP(6) NOT NULL ENABLE,
    TA_NUMERO_DE_EJECUCION INT,
    TA_MATERIA INT,
    TA_CAMARA NUMBER(2),
CONSTRAINT CP_TOTAL_A PRIMARY KEY ("TA_CLAVE"),
CONSTRAINT UQ_VIEJA_CLAVE UNIQUE ("TA_IDEXP", "TA_OFICINA", "TA_RN", "TA_TIPO_DE_DATO", "TA_NUMERO_DE_EJECUCION"),
CONSTRAINT UQ_ID_TABLA_UNIOC UNIQUE("TA_IDCAMBIO"));
...
CREATE TABLE EST_SALIDOS(
    ...
    CONSTRAINT UQ_VIEJA_CLAVE UNIQUE (SAL_IDEXP, SAL_FECHA, SAL_CODIGO, SAL_OFICINA, SAL_RN, SAL_NUMERO_DE_EJECUCION),
